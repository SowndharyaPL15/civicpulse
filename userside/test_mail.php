<?php
/**
 * CivicPulse — Real-Time Mail Diagnostic & Test Tool (Inside userside)
 * Open this in your browser: http://localhost/Civicpulse/userside/test_mail.php
 */
...
<div class="box">
    ...
    <div class="item"><strong>OpenSSL Extension:</strong> <?= extension_loaded('openssl') ? '✅ Enabled' : '❌ Disabled' ?></div>
    ...
    <p style="margin-top:20px; font-size:13px; color:#64748b;">
        <a href="signup.php">← Back to Signup</a> &bull; <a href="verify_otp.php">Verify OTP</a>
    </p>
</div>
</body>
</html>
